import{_ as n,c as i,a2 as a,o as e}from"./chunks/framework.BQmytedh.js";const c=JSON.parse('{"title":"component","description":"","frontmatter":{},"headers":[],"relativePath":"前端/vue/共用/component.md","filePath":"前端/vue/共用/component.md","lastUpdated":1767866075000}'),t={name:"前端/vue/共用/component.md"};function p(l,s,o,h,E,k){return e(),i("div",null,s[0]||(s[0]=[a(`<h1 id="component" tabindex="-1">component <a class="header-anchor" href="#component" aria-label="Permalink to &quot;component&quot;">​</a></h1><p>通过 <code>:is</code>绑定组件名或组件选项对象、支持所有 Vue 组件（包括异步组件）</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">component</span></span>
