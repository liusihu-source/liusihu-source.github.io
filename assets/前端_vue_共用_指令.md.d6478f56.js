import{_ as s,c as n,o as a,a as l}from"./app.02589403.js";const p="/assets/image-20220408151723180.ebcea968.png",u=JSON.parse('{"title":"Vue指令 --笔记","description":"","frontmatter":{},"headers":[{"level":2,"title":"v-for & v-if & v-model","slug":"v-for-v-if-v-model","link":"#v-for-v-if-v-model","children":[]}],"relativePath":"前端/vue/共用/指令.md","lastUpdated":1667130584000}'),o={name:"前端/vue/共用/指令.md"},t=l('<h1 id="vue指令-笔记" tabindex="-1">Vue指令 --笔记 <a class="header-anchor" href="#vue指令-笔记" aria-hidden="true">#</a></h1><p><img src="'+p+`" alt="image-20220408151723180"></p><p><a href="https://cn.vuejs.org/v2/guide/index.html#" target="_blank" rel="noreferrer">https://cn.vuejs.org/v2/guide/index.html#</a></p><h2 id="v-for-v-if-v-model" tabindex="-1">v-for &amp; v-if &amp; v-model <a class="header-anchor" href="#v-for-v-if-v-model" aria-hidden="true">#</a></h2><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">ul</span><span style="color:#89DDFF;">&gt;</span></span>
...
<span class="line"><span style="color:#89DDFF;">                </span><span style="color:#676E95;font-style:italic;">// reduce数组的一个方法，可以用来返回总数</span></span>
...
<span class="line"><span style="color:#89DDFF;">&lt;/script&gt;</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div>`,5),e=[t];function c(r,D,F,y,i,C){return a(),n("div",null,e)}const d=s(o,[["render",c]]);export{u as __pageData,d as default};
