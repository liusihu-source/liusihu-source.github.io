import{_ as s,c as n,o as a,a as l}from"./app.08de8fd9.js";const i=JSON.parse('{"title":"Geoserver使用案例 --笔记","description":"","frontmatter":{},"headers":[],"relativePath":"服务器/geoserver其他.md","lastUpdated":1685620990000}'),p={name:"服务器/geoserver其他.md"},o=l(`<h1 id="geoserver使用案例-笔记" tabindex="-1">Geoserver使用案例 --笔记 <a class="header-anchor" href="#geoserver使用案例-笔记" aria-hidden="true">#</a></h1><ul><li><p>导航道路要先打断相交线</p><ul><li>略（ArcMap拓扑操作）</li></ul></li><li><p>空间数据库的扩展插件</p><div class="language-sql"><button title="Copy Code" class="copy"></button><span class="lang">sql</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#F78C6C;">CREATE</span><span style="color:#A6ACCD;"> EXTENSION postgis;</span></span>
